...
from utils.FCA_layer import MultiSpectralAttentionLayer
...
class Inception_Module(nn.Module):  # try reflection pad
    def __init__(self, in_c, out_c):
        ...
        self.FCA = MultiSpectralAttentionLayer(out_c, c2wh[out_c], c2wh[out_c], reduction=2, freq_sel_method='top16')
