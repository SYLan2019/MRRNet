...
ssim_=0.0
count=0
# DIC_in3f48_x8_Helen_archived_220323-095003/Helen
# for i in os.listdir("./Deep-Iterative-Collaboration/results/DIC_in3f48_x8_Helen_archived_220323-095003/Helen/"):
# for i in os.listdir("./results_helen/SPARNet_trainByInceptionModule_InstanceNorm_GAN_pcp_gradSet_UseSkipConnection_dialtion5X5and7X7_lr0001/"):

for i in os.listdir("./test_dirs/CelebA_test_DIC/HR/"):
    img1=cv2.imread("./results_CelebA/MRRNet_m6d16_10middleBlock_ECAblock_allattention/"+i)
    # print(i)
    # img1=cv2.imread("../Deep-Iterative-Collaboration/results/DIC_in3f48_x8_CelebA/CelebA/"+i)
    img2=cv2.imread("./test_dirs/CelebA_test_DIC/HR/"+i)
    p,s=calc_metrics(img1,img2,8)
    psnr_=psnr_+p
    ssim_=ssim_+s
    count=count+1
print(psnr_/count,ssim_/count,count)
# img1=cv2.imread("C:\\Users\\comin\\Desktop\\32554102961.png")
# img2=cv2.imread("C:\\Users\\comin\\Desktop\\3255410296_1.png")
# p,s=calc_metrics(img1,img2,8)
# print(p,s)