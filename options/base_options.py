...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='mrrnet', help='chooses which model to train [parse|enhance]')
        parser.add_argument('--att_name', type=str, default='mrr', help='attention type')
